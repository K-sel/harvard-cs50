...
| Exercice          | Description                                                                      | Énoncé                                                                                               | Mon code                                                                             |
| ----------------- | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| **Filter (less)** | Application de filtres simples (grayscale, noir et blanc, réflexion) sur des BMP | [Énoncé (filter-less)](https://cs50.harvard.edu/x/2025/psets/4/filter/less/)  | [filter-less.c](https://github.com/K-sel/harvard-cs50/blob/main/week4/filter-less/filter-less.c) |
